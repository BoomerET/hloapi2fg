...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(20);
...
async function main() {
   ...
   await inform()
   jquery__WEBPACK_IMPORTED_MODULE_1___default()('#grabChar').on("click", function() {
      USER_TOKEN = jquery__WEBPACK_IMPORTED_MODULE_1___default()('#userToken').val()
      ELEMENT_TOKEN = jquery__WEBPACK_IMPORTED_MODULE_1___default()('#elementToken').val()
      getCharacter()
   })
   setTimeout(async () => {
...
function setup() {
   ...
   connection = new _aspnet_signalr__WEBPACK_IMPORTED_MODULE_0__["HubConnectionBuilder"]()
      ...
      .configureLogging(_aspnet_signalr__WEBPACK_IMPORTED_MODULE_0__["LogLevel"].Debug)
      .build()
